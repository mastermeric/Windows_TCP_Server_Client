...
SERVER icin Notlar: 
  ...
  IPAddress.Any  oldugu icin  local networkte her connected IP yi  0.0.0.0  yapar!  NORMAL dir.    External  IP lerde asagidakini kullan  //IPEndPoint endpoint = new IPEndPoint(IPAddress.Parse("128.1.0.148"), 1000);
...
namespace WindowsFormsApplication1
{
    public partial class Server_TCPListener_old : Form
    {
        ...
        //  IPAddress.Any  -->  local networkte her connected IP 0.0.0.0  olur  !  NORMALdir.    External  IP lerde asagidakini kullan  //IPEndPoint endpoint = new IPEndPoint(IPAddress.Parse("128.1.0.148"), 1000);
